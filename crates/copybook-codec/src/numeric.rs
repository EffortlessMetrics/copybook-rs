...
mod float;
pub use float::{
    decode_float_double, decode_float_double_ibm_hex, decode_float_double_ieee_be,
    decode_float_double_with_format, decode_float_single, decode_float_single_ibm_hex,
    decode_float_single_ieee_be, decode_float_single_with_format, encode_float_double,
    encode_float_double_ibm_hex, encode_float_double_ieee_be, encode_float_double_with_format,
    encode_float_single, encode_float_single_ibm_hex, encode_float_single_ieee_be,
