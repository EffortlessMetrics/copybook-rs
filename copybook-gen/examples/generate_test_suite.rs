...
use copybook_gen::{
    GeneratorConfig, CopybookTemplate, TestSuiteBuilder,
    generate_complete_test_suite, test_generation::calculate_suite_stats,
};
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("Generated {} test suites with {} total tests", 
    ...
    println!("Custom suite '{}' created with {} tests", 
