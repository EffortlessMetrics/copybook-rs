...
fn test_issue_53_enterprise_production_certification() {
    ...
    // NOTE: Indentation kept minimal to avoid false fixed-form detection;
    //       decimal values in Level-88 THRU replaced with integers (parser limitation)
...
01 ENTERPRISE-CERTIFICATION-RECORD.
 ...
 88 SCORE-EXCELLENT       VALUE 95 THRU 100 OF TOTAL-SCORE.
 88 SCORE-GOOD            VALUE 85 THRU 94 OF TOTAL-SCORE.
 88 SCORE-SATISFACTORY    VALUE 75 THRU 84 OF TOTAL-SCORE.
 88 CONFIDENCE-HIGH       VALUE 90 THRU 100 OF CONFIDENCE-SCORE.
 88 CONFIDENCE-MEDIUM     VALUE 70 THRU 89 OF CONFIDENCE-SCORE.
 88 CONFIDENCE-LOW        VALUE 1 THRU 69 OF CONFIDENCE-SCORE.
";
