...
**Status**: ⚠️ **Engineering Preview (v0.6.1)** - See
...
<!-- TEST_STATUS:BEGIN -->
**conformance:** 9047/9047  • **skipped:** 0<br>
...
- Rust Edition 2024 with MSRV 1.95 (aligned with CI test matrix)
...
### Status: ⚠️ Engineering Preview (v0.6.1) - Cautious Adoption Recommended
