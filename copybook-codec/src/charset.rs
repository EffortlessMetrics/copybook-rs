...
static CP037_TO_UNICODE: [u32; 256] = [
    ...
    0x0020, 0x00A0, 0x00E2, 0x00E4, 0x00E0, 0x00E1, 0x00E3, 0x00E5, // 40-47 (space, nbsp, â, ä, à, á, ã, å)
    0x00E7, 0x00F1, 0x00A2, 0x002E, 0x003C, 0x0028, 0x002B, 0x007C, // 48-4F (ç, ñ, ¢, ., <, (, +, |)
    0x0026, 0x00E9, 0x00EA, 0x00EB, 0x00E8, 0x00ED, 0x00EE, 0x00EF, // 50-57 (&, é, ê, ë, è, í, î, ï)
    0x00EC, 0x00DF, 0x0021, 0x0024, 0x002A, 0x0029, 0x003B, 0x00AC, // 58-5F (ì, ß, !, $, *, ), ;, ¬)
    0x002D, 0x002F, 0x00C2, 0x00C4, 0x00C0, 0x00C1, 0x00C3, 0x00C5, // 60-67 (-, /, Â, Ä, À, Á, Ã, Å)
    0x00C7, 0x00D1, 0x00A6, 0x002C, 0x0025, 0x005F, 0x003E, 0x003F, // 68-6F (Ç, Ñ, ¦, ,, %, _, >, ?)
    0x00F8, 0x00C9, 0x00CA, 0x00CB, 0x00C8, 0x00CD, 0x00CE, 0x00CF, // 70-77 (ø, É, Ê, Ë, È, Í, Î, Ï)
    0x00CC, 0x0060, 0x003A, 0x0023, 0x0040, 0x0027, 0x003D, 0x0022, // 78-7F (Ì, `, :, #, @, ', =, ")
    0x00D8, 0x0061, 0x0062, 0x0063, 0x0064, 0x0065, 0x0066, 0x0067, // 80-87 (Ø, a-g)
    0x0068, 0x0069, 0x00AB, 0x00BB, 0x00F0, 0x00FD, 0x00FE, 0x00B1, // 88-8F (h, i, «, », ð, ý, þ, ±)
    0x00B0, 0x006A, 0x006B, 0x006C, 0x006D, 0x006E, 0x006F, 0x0070, // 90-97 (°, j-p)
    0x0071, 0x0072, 0x00AA, 0x00BA, 0x00E6, 0x00B8, 0x00C6, 0x00A4, // 98-9F (q, r, ª, º, æ, ¸, Æ, ¤)
    0x00B5, 0x007E, 0x0073, 0x0074, 0x0075, 0x0076, 0x0077, 0x0078, // A0-A7 (µ, ~, s-x)
    0x0079, 0x007A, 0x00A1, 0x00BF, 0x00D0, 0x00DD, 0x00DE, 0x00AE, // A8-AF (y, z, ¡, ¿, Ð, Ý, Þ, ®)
    ...
    0x0048, 0x0049, 0x00AD, 0x00F4, 0x00F6, 0x00F2, 0x00F3, 0x00F5, // C8-CF (H, I, ­, ô, ö, ò, ó, õ)
    0x007D, 0x004A, 0x004B, 0x004C, 0x004D, 0x004E, 0x004F, 0x0050, // D0-D7 (}, J-P)
    0x0051, 0x0052, 0x00B9, 0x00FB, 0x00FC, 0x00F9, 0x00FA, 0x00FF, // D8-DF (Q, R, ¹, û, ü, ù, ú, ÿ)
    0x005C, 0x00F7, 0x0053, 0x0054, 0x0055, 0x0056, 0x0057, 0x0058, // E0-E7 (\, ÷, S-X)
    0x0059, 0x005A, 0x00B2, 0x00D4, 0x00D6, 0x00D2, 0x00D3, 0x00D5, // E8-EF (Y, Z, ², Ô, Ö, Ò, Ó, Õ)
    0x0030, 0x0031, 0x0032, 0x0033, 0x0034, 0x0035, 0x0036, 0x0037, // F0-F7 (0-7)
    0x0038, 0x0039, 0x00B3, 0x00DB, 0x00DC, 0x00D9, 0x00DA, 0x009F, // F8-FF (8, 9, ³, Û, Ü, Ù, Ú, control)
];
...
static CP273_TO_UNICODE: [u32; 256] = [
    ...
    0x0090, 0x0091, 0x0016, 0x0093, 0x0094, 0x0095, 0x0096, 0x0004, // 30-37
    0x0098, 0x0099, 0x009A, 0x009B, 0x0014, 0x0015, 0x009E, 0x001A, // 38-3F
    0x0020, 0x00A0, 0x00E2, 0x007B, 0x00E0, 0x00E1, 0x00E3, 0x00E5, // 40-47 (space, nbsp, â, {, à, á, ã, å)
    0x00E7, 0x00F1, 0x00C4, 0x002E, 0x003C, 0x0028, 0x002B, 0x0021, // 48-4F (ç, ñ, Ä, ., <, (, +, !)
    0x0026, 0x00E9, 0x00EA, 0x00EB, 0x00E8, 0x00ED, 0x00EE, 0x00EF, // 50-57 (&, é, ê, ë, è, í, î, ï)
    0x00EC, 0x00DF, 0x00DC, 0x0024, 0x002A, 0x0029, 0x003B, 0x005E, // 58-5F (ì, ß, Ü, $, *, ), ;, ^)
    0x002D, 0x002F, 0x00C2, 0x005B, 0x00C0, 0x00C1, 0x00C3, 0x00C5, // 60-67 (-, /, Â, [, À, Á, Ã, Å)
    0x00C7, 0x00D1, 0x00F6, 0x002C, 0x0025, 0x005F, 0x003E, 0x003F, // 68-6F (Ç, Ñ, ö, ,, %, _, >, ?)
    0x00F8, 0x00C9, 0x00CA, 0x00CB, 0x00C8, 0x00CD, 0x00CE, 0x00CF, // 70-77 (ø, É, Ê, Ë, È, Í, Î, Ï)
    0x00CC, 0x0060, 0x003A, 0x0023, 0x00A7, 0x0027, 0x003D, 0x0022, // 78-7F (Ì, `, :, #, §, ', =, ")
    0x00D8, 0x0061, 0x0062, 0x0063, 0x0064, 0x0065, 0x0066, 0x0067, // 80-87 (Ø, a-g)
    0x0068, 0x0069, 0x00AB, 0x00BB, 0x00F0, 0x00FD, 0x00FE, 0x00B1, // 88-8F (h, i, «, », ð, ý, þ, ±)
    0x00B0, 0x006A, 0x006B, 0x006C, 0x006D, 0x006E, 0x006F, 0x0070, // 90-97 (°, j-p)
    0x0071, 0x0072, 0x00AA, 0x00BA, 0x00E6, 0x00B8, 0x00C6, 0x00A4, // 98-9F (q, r, ª, º, æ, ¸, Æ, ¤)
    ...
    0x0048, 0x0049, 0x00AD, 0x00F4, 0x00A6, 0x00F2, 0x00F3, 0x00F5, // C8-CF (H, I, ­, ô, ¦, ò, ó, õ)
    0x00FC, 0x004A, 0x004B, 0x004C, 0x004D, 0x004E, 0x004F, 0x0050, // D0-D7 (ü, J-P)
    0x0051, 0x0052, 0x00B9, 0x00FB, 0x007D, 0x00F9, 0x00FA, 0x00FF, // D8-DF (Q, R, ¹, û, }, ù, ú, ÿ)
    0x00D6, 0x00F7, 0x0053, 0x0054, 0x0055, 0x0056, 0x0057, 0x0058, // E0-E7 (Ö, ÷, S-X)
    0x0059, 0x005A, 0x00B2, 0x00D4, 0x005C, 0x00D2, 0x00D3, 0x00D5, // E8-EF (Y, Z, ², Ô, \, Ò, Ó, Õ)
    0x0030, 0x0031, 0x0032, 0x0033, 0x0034, 0x0035, 0x0036, 0x0037, // F0-F7 (0-7)
    0x0038, 0x0039, 0x00B3, 0x00DB, 0x005D, 0x00D9, 0x00DA, 0x009F, // F8-FF (8, 9, ³, Û, ], Ù, Ú, control)
];
...
static CP500_TO_UNICODE: [u32; 256] = [
    ...
    0x0098, 0x0099, 0x009A, 0x009B, 0x0014, 0x0015, 0x009E, 0x001A, // 38-3F
    0x0020, 0x00A0, 0x00E2, 0x00E4, 0x00E0, 0x00E1, 0x00E3, 0x00E5, // 40-47 (space, nbsp, â, ä, à, á, ã, å)
    0x00E7, 0x00F1, 0x005B, 0x002E, 0x003C, 0x0028, 0x002B, 0x0021, // 48-4F (ç, ñ, [, ., <, (, +, !)
    0x0026, 0x00E9, 0x00EA, 0x00EB, 0x00E8, 0x00ED, 0x00EE, 0x00EF, // 50-57 (&, é, ê, ë, è, í, î, ï)
    0x00EC, 0x00DF, 0x005D, 0x0024, 0x002A, 0x0029, 0x003B, 0x005E, // 58-5F (ì, ß, ], $, *, ), ;, ^)
    0x002D, 0x002F, 0x00C2, 0x00C4, 0x00C0, 0x00C1, 0x00C3, 0x00C5, // 60-67 (-, /, Â, Ä, À, Á, Ã, Å)
    0x00C7, 0x00D1, 0x00A6, 0x002C, 0x0025, 0x005F, 0x003E, 0x003F, // 68-6F (Ç, Ñ, ¦, ,, %, _, >, ?)
    0x00F8, 0x00C9, 0x00CA, 0x00CB, 0x00C8, 0x00CD, 0x00CE, 0x00CF, // 70-77 (ø, É, Ê, Ë, È, Í, Î, Ï)
    0x00CC, 0x0060, 0x003A, 0x0023, 0x0040, 0x0027, 0x003D, 0x0022, // 78-7F (Ì, `, :, #, @, ', =, ")
...
static CP1047_TO_UNICODE: [u32; 256] = [
    ...
    0x0071, 0x0072, 0x00AA, 0x00BA, 0x00E6, 0x00B8, 0x00C6, 0x00A4, // 98-9F (q, r, ª, º, æ, ¸, Æ, ¤)
    0x00B5, 0x007E, 0x0073, 0x0074, 0x0075, 0x0076, 0x0077, 0x0078, // A0-A7 (µ, ~, s-x)
    0x0079, 0x007A, 0x00A1, 0x00BF, 0x00D0, 0x005B, 0x00DE, 0x00AE, // A8-AF (y, z, ¡, ¿, Ð, [, Þ, ®)
    0x005E, 0x00A3, 0x00A5, 0x00B7, 0x00A9, 0x00A7, 0x00B6, 0x00BC, // B0-B7 (^, £, ¥, ·, ©, §, ¶, ¼)
    0x00BD, 0x00BE, 0x00DD, 0x00A8, 0x00AF, 0x005D, 0x00B4, 0x00D7, // B8-BF (½, ¾, Ý, ¨, ¯, ], ´, ×)
    0x007B, 0x0041, 0x0042, 0x0043, 0x0044, 0x0045, 0x0046, 0x0047, // C0-C7 ({, A-G)
    0x0048, 0x0049, 0x00AD, 0x00F4, 0x00F6, 0x00F2, 0x00F3, 0x00F5, // C8-CF (H, I, ­, ô, ö, ò, ó, õ)
    0x007D, 0x004A, 0x004B, 0x004C, 0x004D, 0x004E, 0x004F, 0x0050, // D0-D7 (}, J-P)
    0x0051, 0x0052, 0x00B9, 0x00FB, 0x00FC, 0x00F9, 0x00FA, 0x00FF, // D8-DF (Q, R, ¹, û, ü, ù, ú, ÿ)
...
static CP1140_TO_UNICODE: [u32; 256] = [
    ...
    0x0059, 0x005A, 0x00B2, 0x00D4, 0x00D6, 0x00D2, 0x00D3, 0x00D5, // E8-EF (Y, Z, ², Ô, Ö, Ò, Ó, Õ)
    0x0030, 0x0031, 0x0032, 0x0033, 0x0034, 0x0035, 0x0036, 0x0037, // F0-F7 (0-7)
    0x0038, 0x0039, 0x00B3, 0x00DB, 0x00DC, 0x00D9, 0x00DA, 0x20AC, // F8-FF (8, 9, ³, Û, Ü, Ù, Ú, €)
];
...
pub fn ebcdic_to_utf8(
    ...
    for &byte in data {
        ...
        if unicode_point < 0x20 && unicode_point != 0x09 && unicode_point != 0x0A && unicode_point != 0x0D {
            match policy {
