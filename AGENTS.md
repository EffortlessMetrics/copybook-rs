...
- **Language / toolchain**: Rust, edition 2024, MSRV 1.98 (enforced in CI and
...
just check-msrv            # cargo +1.98.0 check --workspace
...
- The workspace uses Rust 2024 with MSRV 1.98. Preserve MSRV unless the change
