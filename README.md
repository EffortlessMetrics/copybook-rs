...
<p align="center">
  <em>Rust toolkit for COBOL copybook parsing and fixed-record data conversion.</em>
</p>

<!-- Public Shields endpoint JSON under badges/ is generated by `cargo xtask badges`; verify with `cargo xtask badges --check`. -->

Deterministic, memory-safe, zero `unsafe` in public APIs.
...
| [Verification](docs/VERIFICATION.md) | README badge meanings, generated endpoints, and PR evidence boundaries |
