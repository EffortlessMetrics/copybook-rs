...
- Engineering Preview v0.6.0
- 26 publishable crates under `crates/` (24 core + 2 facade), 4 dev-only under `tools/`, 3 test suites under `tests/`
...
```
crates/                           # 26 publishable crates (24 core + 2 facade)
