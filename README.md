...
curl -LO https://github.com/EffortlessMetrics/copybook-rs/raw/v0.7.0/fixtures/copybooks/simple.cpy
curl -LO https://github.com/EffortlessMetrics/copybook-rs/raw/v0.7.0/fixtures/data/simple.bin
...
To build from source instead, clone the repo, `git checkout v0.7.0`, and
`cargo build --release`; the binary is `./target/release/copybook`.

## Status

Engineering Preview (v0.7.0). Stable CLI and library APIs; feature completeness
