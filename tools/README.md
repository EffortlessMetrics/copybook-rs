...
cargo run --quiet --manifest-path tools/copybook-scripts/Cargo.toml -- check-performance-docs
...
cargo run --quiet --manifest-path tools/copybook-scripts/Cargo.toml -- validate-perf-receipt scripts/bench/perf.json
