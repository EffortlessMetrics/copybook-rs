...
//! Property tests for corruption detection microcrate invariants.
...
proptest! {
    ...
    fn prop_rdw_ascii_corruption_detects_ascii_length_bytes(
        ...
        let error = detect_rdw_ascii_corruption(&header)
    ...
    fn prop_rdw_ascii_corruption_returns_none_for_short_headers(
        ...
        let error = detect_rdw_ascii_corruption(&data);
...
proptest! {
    ...
    fn prop_packed_corruption_detects_invalid_high_nibble(
        ...
        let errors = detect_packed_corruption(&data, "FIELD");
        prop_assert!(!errors.is_empty());
        prop_assert!(
            errors
                .iter()
