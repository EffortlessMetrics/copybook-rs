...
//! for performance, along with codepage and character encoding types.
...
// ============================================================================
// Codepage types (moved from copybook-codec/src/options.rs)
// ============================================================================
...
/// dedicated ASCII overpunch helpers.
...
/// # Example
/// ```
/// use copybook_charset::{Codepage, space_byte};
///
