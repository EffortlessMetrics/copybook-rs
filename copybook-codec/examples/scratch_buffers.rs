...
fn main() {
    ...
    println!("   - string_buffer: {} chars", scratch.string_buffer.capacity());
    ...
    println!("byte_buffer: {:?}", String::from_utf8_lossy(&scratch.byte_buffer));
    ...
    println!("byte_buffer capacity: {} bytes", scratch.byte_buffer.capacity());
    ...
    println!("Pre-allocated byte_buffer: {} bytes", scratch.byte_buffer.capacity());
    println!("Pre-allocated string_buffer: {} chars", scratch.string_buffer.capacity());
    ...
    println!("Processing {} records with scratch buffer reuse...", records.len());
