...
///
/// ```
/// use copybook_core::lexer::CobolFormat;
///
...
impl From<&crate::parser::ParseOptions> for LexerOptions {
    fn from(options: &crate::parser::ParseOptions) -> Self {
        Self {
...
impl<'a> Lexer<'a> {
    ...
    #[inline]
    pub fn new_with_options<O>(input: &'a str, options: O) -> Self
    where
        O: Into<LexerOptions>,
    {
