...
pub trait OptionExt<T> {
    ...
    ///
    /// # Errors
    /// Returns the specified error code and message when the option is `None`.
    ...
    ///
    /// # Errors
    /// Returns the provided error when the option is `None`.
...
pub trait VecExt<T> {
    ...
    ///
    /// # Errors
    /// Returns the specified error code and message when the vector is empty.
...
pub trait SliceExt<T> {
    ...
    ///
    /// # Errors
    /// Returns the specified error code and message when the index is out of bounds.
