...
The complete Diátaxis mapping is maintained in **[diataxis.manifest.yml](diataxis.manifest.yml)**.
Use the four folder readmes for discoverable paths:
- `tutorials/README.md`
- `how-to/README.md`
...
**Performance**: Receipts generated by `scripts/bench.sh` live in `scripts/bench/perf.json`; see [PERFORMANCE_GOVERNANCE.md](PERFORMANCE_GOVERNANCE.md) for policy
**Quality**: 10,250+ tests passing (15 ignored), zero unsafe code, comprehensive error taxonomy (CBKP/CBKS/CBKD/CBKE/CBKR/CBKC/CBKF/CBKI/CBKA/CBKW)
...
- Use the full tutorial index: **[docs/tutorials/README.md](tutorials/README.md)**
...
### Quality Assurance
- **[Production Readiness Report](PRODUCTION_READINESS.md)** - System readiness and architectural validation outcomes
