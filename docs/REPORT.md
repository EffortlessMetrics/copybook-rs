...
**Status**: ⚠️ **Engineering Preview (v0.8.1)** - See
...
<!-- TEST_STATUS:BEGIN -->
**conformance:** 9198/9198  • **skipped:** 0<br>
...
- Rust Edition 2024 with MSRV 1.98 (aligned with CI test matrix)
...
### Status: ⚠️ Engineering Preview (v0.8.1) - Cautious Adoption Recommended
