...
fn main() {
    ...
    println!(
        "  Format: {} ({})",
        decode_opts.format,
        decode_opts.format.description()
    );
    println!(
        "  Codepage: {} ({})",
        decode_opts.codepage,
        decode_opts.codepage.description()
    );
    println!(
        "  JSON Number Mode: {} ({})",
    ...
    println!(
        "  Format: {} ({})",
        encode_opts.format,
        encode_opts.format.description()
    );
    println!(
        "  Codepage: {} ({})",
        encode_opts.codepage,
        encode_opts.codepage.description()
    );
    ...
    println!(
        "  RecordFormat::Fixed.is_fixed(): {}",
        RecordFormat::Fixed.is_fixed()
    );
    println!(
        "  RecordFormat::RDW.is_variable(): {}",
        RecordFormat::RDW.is_variable()
    );
    println!(
        "  Codepage::ASCII.is_ascii(): {}",
        Codepage::ASCII.is_ascii()
    );
    println!(
        "  Codepage::CP037.is_ebcdic(): {}",
        Codepage::CP037.is_ebcdic()
    );
    println!(
        "  Codepage::CP1140.code_page_number(): {:?}",
        Codepage::CP1140.code_page_number()
    );
    println!(
        "  JsonNumberMode::Lossless.is_lossless(): {}",
        JsonNumberMode::Lossless.is_lossless()
    );
    println!(
        "  JsonNumberMode::Native.is_native(): {}",
        JsonNumberMode::Native.is_native()
    );
