...
**Status**: copybook-rs is in Engineering Preview (v0.8.0). Suitable for teams that validate copybooks against supported features. Production deployment requires pilot validation on representative workloads. See [ROADMAP.md](ROADMAP.md) for adoption guidance.
## License
