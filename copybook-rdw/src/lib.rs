...
const RDW_READER_BUF_CAPACITY: usize = RDW_MAX_PAYLOAD_LEN + RDW_HEADER_LEN;

pub use copybook_rdw_header::{
    RDW_HEADER_LEN, RDW_MAX_PAYLOAD_LEN, RdwHeader, rdw_is_suspect_ascii_corruption,
    rdw_payload_len_to_u16, rdw_read_len, rdw_slice_body, rdw_try_peek_len,
};
